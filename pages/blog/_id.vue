<template>
  ...
  <section class="blogs_inside">
    <BreadCrumb
      :BreadCrumbTitle="getBlogs.title"
              ...
              <div class="container">
                <div class="row">
                  <div class="col-12 col-sm-12 col-md-6 col-lg-4" v-for="blogs in limitedNews" :key="news.id">
                    <BlogsItem :blogsId="blogs.id"
                               :blogsImage="blogs.image"
                               :blogsDescription="blogs.title"
                               :blogsContent="blogs.description"
                               :blogsPublishDate="blogs.created_at">
                    </BlogsItem>
                  </div>
                </div>
              </div>
